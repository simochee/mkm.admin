...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('menu-list', '<ol class="menu-list-wrapper"> <li each="{type in data}"> <ol class="menu-list"> <li each="{cat in type.list}" onload="{cat.isOpen = false}" onclick="{toggleItem(this)}"> <div class="category">{cat.ja}</div> <ol if="{false}" class="menu-item"> <li each="{item in cat.menu}">{item.name}</li> </ol> </li> </ol> </li> </ol>', 'menu-list .menu-list-wrapper .menu-list .category,[riot-tag="menu-list"] .menu-list-wrapper .menu-list .category,[data-is="menu-list"] .menu-list-wrapper .menu-list .category{ position: relative; width: 100%; height: 40px; border-bottom: 1px solid #ccc; line-height: 40px; text-align: center; } menu-list .menu-list-wrapper .menu-list .category::before,[riot-tag="menu-list"] .menu-list-wrapper .menu-list .category::before,[data-is="menu-list"] .menu-list-wrapper .menu-list .category::before{ content: "\\f123"; position: absolute; left: 0; display: block; width: 40px; height: 40px; text-align: center; line-height: 40px; font-family: \'Ionicons\'; font-size: 13px; transform: rotate(-90deg); }', '', function (opts) {
	    var store = __webpack_require__(9);
	    var self = this;
