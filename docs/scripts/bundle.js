...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('news-editor-body', '<div class="news-editor-body"> <ul class="toolbar"> <li class="tool-item"><i class="fa fa-font"></i></li> <li class="tool-item"><i class="fa fa-align-left"></i></li> <li class="tool-item"><i class="fa fa-header"></i></li> <li class="tool-item"><i class="fa fa-image"></i></li> <li class="tool-item"><i class="fa fa-chain"></i></li> <li class="tool-item"><i class="fa fa-undo"></i></li> <li class="tool-item"><i class="fa fa-code"></i></li> </ul> <div class="editor"> <div class="header"> <div class="title">{opts.title || \'No Title\'}</div> <div class="date">2016/11/01</div> </div> <div id="editor"></div> </div> </div>', 'news-editor-body .news-editor-body,[riot-tag="news-editor-body"] .news-editor-body,[data-is="news-editor-body"] .news-editor-body{ margin: 0 -12px; } news-editor-body .news-editor-body .toolbar,[riot-tag="news-editor-body"] .news-editor-body .toolbar,[data-is="news-editor-body"] .news-editor-body .toolbar{ width: 280px; height: 40px; margin: 0 auto; border: 1px solid #aaa; border-radius: 3px; } news-editor-body .news-editor-body .toolbar .tool-item,[riot-tag="news-editor-body"] .news-editor-body .toolbar .tool-item,[data-is="news-editor-body"] .news-editor-body .toolbar .tool-item{ float: left; width: 40px; height: 40px; box-sizing: border-box; line-height: 40px; text-align: center; } news-editor-body .news-editor-body .toolbar .tool-item:not(:last-child),[riot-tag="news-editor-body"] .news-editor-body .toolbar .tool-item:not(:last-child),[data-is="news-editor-body"] .news-editor-body .toolbar .tool-item:not(:last-child){ border-right: 1px solid #aaa; } news-editor-body .news-editor-body .toolbar .tool-item:hover,[riot-tag="news-editor-body"] .news-editor-body .toolbar .tool-item:hover,[data-is="news-editor-body"] .news-editor-body .toolbar .tool-item:hover{ border-bottom: 3px solid #02aedc; } news-editor-body .editor,[riot-tag="news-editor-body"] .editor,[data-is="news-editor-body"] .editor{ position: relative; width: 100%; padding-top: 30px; padding-bottom: 30px; background: #000; color: #fff; } news-editor-body .editor .header .title,[riot-tag="news-editor-body"] .editor .header .title,[data-is="news-editor-body"] .editor .header .title{ display: block; position: relative; width: 100%; padding: 5px 5px 10px; box-sizing: border-box; font-size: 24px; line-height: 30px; } news-editor-body .editor .header .title::after,[riot-tag="news-editor-body"] .editor .header .title::after,[data-is="news-editor-body"] .editor .header .title::after{ content: \'\'; position: absolute; bottom: 0; right: 1%; left: 1%; height: 1px; background-image: linear-gradient(to right, #000000, #888888); } news-editor-body .editor .header .date,[riot-tag="news-editor-body"] .editor .header .date,[data-is="news-editor-body"] .editor .header .date{ margin: 10px 10px 0 0; text-align: right; font-size: 12px; color: #aaa; } news-editor-body .editor iframe,[riot-tag="news-editor-body"] .editor iframe,[data-is="news-editor-body"] .editor iframe{ display: block; width: 95%; margin: 0 auto; border: none; background: none; }', '', function (opts) {
	    this.on('mount', function () {
	        // Squireオブジェクト
	        var editor;
