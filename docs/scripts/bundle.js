...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('recommend', '<navbar title="{opts.title}"></navbar> <div class="{edit ? \'edit\' : \'display\'}"> <div class="header"> <h2> <div class="input"> <input value="{data.title}" __readonly="{!edit}"> </div> </h2> <button type="button" onclick="{toggleMode}" class="btn btn-small btn-{edit ? \'danger\' : \'edit\'}">{edit ? \'終了\' : \'編集\'}</button> </div> </div>', 'recommend .header,[riot-tag="recommend"] .header,[data-is="recommend"] .header{ display: -webkit-flex; display: -moz-flex; display: -ms-flex; display: -o-flex; display: flex; align-items: center; justify-content: space-between; margin: 10px 15px; } recommend .header h2,[riot-tag="recommend"] .header h2,[data-is="recommend"] .header h2{ flex: 1; margin-right: 10px; } recommend .header h2 .input input,[riot-tag="recommend"] .header h2 .input input,[data-is="recommend"] .header h2 .input input{ width: 100%; padding: 0 5px; box-sizing: border-box; border: none; font-size: 20px; line-height: 40px; } recommend .edit .input,[riot-tag="recommend"] .edit .input,[data-is="recommend"] .edit .input{ position: relative; } recommend .edit .input::before,[riot-tag="recommend"] .edit .input::before,[data-is="recommend"] .edit .input::before{ content: ""; position: absolute; left: 0; bottom: 0; display: block; width: 100%; height: 2px; border-top: 0; border-left: 1px solid #aaa; border-bottom: 1px solid #aaa; border-right: 1px solid #aaa; } recommend .display .input input,[riot-tag="recommend"] .display .input input,[data-is="recommend"] .display .input input{ overflow: hidden; white-space: nowrap; text-overflow: ellipsis; } recommend .btn,[riot-tag="recommend"] .btn,[data-is="recommend"] .btn{ border: none; } recommend .btn.btn-small,[riot-tag="recommend"] .btn.btn-small,[data-is="recommend"] .btn.btn-small{ height: 30px; padding: 0 15px; font-size: 14px; line-height: 30px; } recommend .btn.btn-edit,[riot-tag="recommend"] .btn.btn-edit,[data-is="recommend"] .btn.btn-edit{ background: #009688; color: #fff; } recommend .btn.btn-danger,[riot-tag="recommend"] .btn.btn-danger,[data-is="recommend"] .btn.btn-danger{ background: #eb2142; color: #fff; }', '', function (opts) {
	...
	module.exports = {
		getRecommend: function getRecommend(eventName) {
			...
			// 取得されていない場合
					...
					request.get('./assets/recommend.json').end(function (err, res) {
						if (err) throw err;
